<template>
    <footer id="footer">
			<ul>
				...
				<!-- 3.0语法 -->
				<router-link to="/movie" custom :isActive=true v-slot="{ navigate,isActive }">
					<li 
					:class="[isActive && 'router-link-active', 'iconfont icon-dianying']"
					@click="navigate"><p>电影</p></li>
				</router-link>
				<router-link to="/cinema" custom :isActive=true v-slot="{ navigate,isActive }">
					<li 
					:class="[isActive && 'router-link-active', 'iconfont icon-yingyuan']"
					@click="navigate"><p>影院</p></li>
				</router-link>
				<router-link to="/mine" 
					custom :isActive=true v-slot="{ navigate,isActive }">
					<li 
					:class="[isActive && 'router-link-active', 'iconfont icon-wode']"
					@click="navigate"><p>我的</p></li>
				</router-link>
